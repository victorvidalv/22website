    ...
    this.setViewpoint = function(point)
    {
        ...
        switch(point) {
            case "front":
                ...
                document.getElementById("orthoViewPointFront").setAttribute('bind','true');
				document.getElementById("orthoViewPointFront").setAttribute('viewAll','true');
				setbboxcenter();
                runtime.resetView();
                // runtime.examine();
            ...
            case "back":
                ...
                document.getElementById("orthoViewPointBack").setAttribute('bind','true');
                document.getElementById("orthoViewPointBack").setAttribute('viewAll','true');
				setbboxcenter();
				runtime.resetView();
                // runtime.examine();
                // document.getElementById("planeId").setAttribute("rotation", "1 0 0 0");
            ...
            case "right":
                ...
                document.getElementById("orthoViewPointRight").setAttribute('bind','true');
                document.getElementById("orthoViewPointRight").setAttribute('viewAll','true');
				setbboxcenter();
                runtime.resetView();
                // runtime.examine();
            ...
            case "left":
                ...
                document.getElementById("orthoViewPointLeft").setAttribute('bind','true');
                document.getElementById("orthoViewPointLeft").setAttribute('viewAll','true');
				setbboxcenter();
                runtime.resetView();
                // runtime.examine();
                // document.getElementById("planeId").setAttribute("rotation", "0 1 0 " + Math.PI / 2);
            ...
            case "top":
                ...
                document.getElementById("orthoViewPointTop").setAttribute('bind','true');
                document.getElementById("orthoViewPointTop").setAttribute('viewAll','true');
				setbboxcenter();				
                runtime.resetView();
                // runtime.examine();
            ...
            case "bottom":
                ...
                document.getElementById("orthoViewPointBottom").setAttribute('bind','true');
                document.getElementById("orthoViewPointBottom").setAttribute('viewAll','true');
				setbboxcenter();
                runtime.resetView();
                // runtime.examine();
                // document.getElementById("planeId").setAttribute("rotation", "1 0 0 -" + Math.PI / 2);
            ...
            case "free":
                ...
                document.getElementById("viewPoint").setAttribute('bind','true');
                document.getElementById("viewPoint").setAttribute('viewAll','true');
				setbboxcenter();
                runtime.resetView();
